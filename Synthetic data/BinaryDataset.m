classdef BinaryDataset < handle
    ...
    properties
        ...
        % shape properties
        factor = 0.7 % scale factor (0-1) between two circles
        noise = 0.3
        angle = 150
        ratio = 0.3
        xlimt
        ylimt
        zlimt
        scatterSize = 60 % size of scatter
        zlimt_down = -1
        zlimt_up = 1
    end
    ...
    methods
        ...
        function banana(obj)
            ...
            class_p_x = cos(class_p)-0.1+obj.noise*rand(1, obj.number(1, 1));
            class_p_y = sin(class_p)+obj.noise*rand(1, obj.number(1, 1));
            
            %%
            class_n_x = 1-cos(class_n)+0.5+obj.noise*rand(1, obj.number(1, 2));
            class_n_y = 1-sin(class_n)-0.5+obj.noise*rand(1, obj.number(1, 2));
%%
            obj.data = [[class_p_x', class_p_y']; [class_n_x', class_n_y']];
            obj.label = [zeros(obj.number(1, 1), 1); ones(obj.number(1, 2), 1)];
        ...
        function plot(obj)
            ...
            switch obj.dimensionality
                case 2
                    scatter(obj.data(obj.label==0, 1), ...
                        obj.data(obj.label==0, 2), ...
                        obj.scatterSize,...
                        'Marker', 'o',...
                        'MarkerEdgeColor', 'k', ...
                ...
                case 3
                    scatter3(obj.data(obj.label==0, 1), ...
                        obj.data(obj.label==0, 2), ...
                        obj.data(obj.label==0, 3), ...
                        obj.scatterSize,...
                        'Marker', 'o',...
                        'MarkerEdgeColor', 'k', ...
                        'MarkerFaceColor', [31, 119, 180]/255)
